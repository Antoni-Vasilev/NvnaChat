...
const sounds = {
    move: new Audio('/tetris/sounds/.mp3'),
    rotate: new Audio('/tetris/sounds/.mp3'),
    drop: new Audio('/tetris/sounds/move.mp3'),
    clear: new Audio('/tetris/sounds/clear.mp3'),
};
...
const backgroundMusic = new Audio('/tetris/sounds/background.mp3');
